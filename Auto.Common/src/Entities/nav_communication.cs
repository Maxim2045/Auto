...
namespace Auto.Common.src.Entities
{
	...
	public partial class nav_communication : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Auto.Common.src.Entities.nav_communicationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.src.Entities.nav_communicationState)(System.Enum.ToObject(typeof(Auto.Common.src.Entities.nav_communicationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Communications
		/// </summary>
		...
		public Auto.Common.src.Entities.Contact nav_contact_nav_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Auto.Common.src.Entities.Contact>("nav_contact_nav_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_communication_contactid");
				this.SetRelatedEntity<Auto.Common.src.Entities.Contact>("nav_contact_nav_communication_contactid", null, value);
