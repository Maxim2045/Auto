...
namespace Auto.Common.src.Entities
{
	...
	public partial class nav_credit : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Auto.Common.src.Entities.nav_creditState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.src.Entities.nav_creditState)(System.Enum.ToObject(typeof(Auto.Common.src.Entities.nav_creditState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Credits
		/// </summary>
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.src.Entities.nav_agreement> nav_nav_credit_nav_agreement_creditid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.src.Entities.nav_agreement>("nav_nav_credit_nav_agreement_creditid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_agreement_creditid");
				this.SetRelatedEntities<Auto.Common.src.Entities.nav_agreement>("nav_nav_credit_nav_agreement_creditid", null, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.src.Entities.nav_auto> nav_nav_credit_nav_auto
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.src.Entities.nav_auto>("nav_nav_credit_nav_auto", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_auto");
				this.SetRelatedEntities<Auto.Common.src.Entities.nav_auto>("nav_nav_credit_nav_auto", null, value);
